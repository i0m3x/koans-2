...
test("assigning functions to variables", function() {
    ...
    equals(triple(4),  [FILL IN], 'what is triple 4?');		
});
...
test("self invoking functions", function() {		
    ...
    (function(pv) {
        ...
        equals(pv,  [FILL IN], 'what is the value of pv?');
        equals(typeof(secretValue),  [FILL IN], "is secretValue available in this context?");
        equals(typeof(publicValue),  [FILL IN], "is publicValue available in this context?");
    })(publicValue);
...
test("arguments array", function() {
    ...
    equals(add(1,2,3,4,5),  [FILL IN], "add 1,2,3,4,5");
    equals(add(4,7,-2),  [FILL IN], "add 4,7,-2");
});
...
test("using call to invoke function",function(){
    ...
    equals(result,  [FILL IN], "what will the value of invokee's this be?");
});
