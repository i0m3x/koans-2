...
test("defining a 'class'", function() {
    ...
    equals(eric.sayHi(), [FILL IN], 'what will Eric say?');
});
...
test("more functions", function() {
    ...
    equals(bobby.favouriteSaying(), [FILL IN], "what is Bobby's favourite saying?");
});
...
test("calling functions added to a prototype after an object was created", function() {
    ...
    equals(paul.numberOfLettersInName(), [FILL IN], "how long is Paul's name?");
});
...
test("Inheritance", function() {
    ...
    equals(lenny.sayHi(), [FILL IN], "what does Lenny say?");
    equals(lenny.wingspan, [FILL IN], "what is Lenny's wingspan?");
});